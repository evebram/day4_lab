...
#     result = likes_to_eat("bread")
#     assert_equal(true, result)
# end
#
# def test_likes_to_eat_false
#     result = likes_to_eat("spinach")
...
# end
  ...
  # (hint: This function should not return anything. After the function call, check for the length of the array to test it!)

  # def test_add_friend
  #     result = add_friend("Scrappy Doo")
  ...
  #   result = number_of_friends(@person4, 0)
  #   assert_equal(2, result)
  # end
